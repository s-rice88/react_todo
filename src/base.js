...
//Your web app's Firebase configuration is written below. If you have a terminal running when you put this together,
//make sure you close it and run a fresh 'npm start'
...
//Initialize authentication from firebase. The code below should remind you to connect authentication
//from Firebase to an OAuth app in Github (we will navigate to github.com to create this).
